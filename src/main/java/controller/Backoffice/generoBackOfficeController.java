		...
		try {
			...
			// ELIMINAR	
				...
				try {
					...
					request.setAttribute("alerta", new Alerta("warning", "Genero tiene libros asociados y no se puede eliminar"));
				}	
			...
			// para hacer el forward pierde la utima parte de la url "genero" y debemos añadir la careta donde esta la index de los generos
